...
if [ "$INSTALL_MODE" = "harness" ]; then
    ...
    echo ""
    echo -e "  ${BOLD}4.${NC} Run the setup wizard (walks you through DB, API keys, channels):"
    echo -e "     ${GREEN}growthclaw init${NC}"
    echo ""
    echo -e "  ${BOLD}5.${NC} Discover your business:"
    ...
    echo -e "     ${GREEN}createdb autogrow_internal${NC}"
    echo ""
    echo -e "  ${BOLD}3.${NC} Run the setup wizard (walks you through DB, API keys, channels):"
    echo -e "     ${GREEN}growthclaw init${NC}"
    echo ""
    echo -e "  ${BOLD}4.${NC} Discover your business:"
    echo -e "     ${GREEN}growthclaw migrate${NC}"
    echo -e "     ${GREEN}growthclaw onboard${NC}"
    echo ""
